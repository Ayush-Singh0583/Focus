...
export default function TaskItem({ task, onEdit, onDetail, onDelete, compact }) {
  ...
  const { running, formatElapsed, start, stop, loading: timerLoading } =
    useTimer(task)
  ...
  const toggleComplete = async () => {
    ...
    if (completing) return   // prevents spam clicking
      ...
      <div className="flex-1 min-w-0">
        ...
        {!compact &&
          ...
          task.progress < 100 && (
            ...
            <div className="mt-2 h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden w-32">
